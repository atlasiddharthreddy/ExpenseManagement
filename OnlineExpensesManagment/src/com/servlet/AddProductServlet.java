...
public class AddProductServlet extends HttpServlet {
	...
	Product product=new Product(pid,request.getParameter("pname"), Float.parseFloat(request.getParameter("pprice")), request.getParameter("pcateory"),(String) session.getAttribute("uname"));
